    ...
    <div class="container panel-container">
        ...
        <div class="panel-slider-container">
            ...
            <div class="panel-slider-container-item containerId" data-slider="{{$slider->id}}">
                ...
                {!! Form::open(['url' => ['admin/slider/destroy', $slider->id], 'method' => 'DELETE', 'class' => 'form-slider-destroy']) !!}
                <div class="item-bg">
...
<div class="modal fade" id="modalSliderUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        ...
        {!! Form::open(['url' => 'admin/slider/update' ,'method' => 'PUT', 'id' => 'form-edit','class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
...
{!! Form::open(['url' => ['admin/slider/show', 'IDShow'], 'method' => 'GET', 'id' => 'form-show']) !!}
{!! Form::close() !!}
