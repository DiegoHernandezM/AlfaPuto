            ...
            <div class="panel panel-default"></br></br></br></br></br>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('las_name') ? ' has-error' : '' }}">
                            <label for="las_name" class="col-md-4 control-label">Apellido</label>
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            <label for="las_name" class="col-md-4 control-label">Direccion</label>
